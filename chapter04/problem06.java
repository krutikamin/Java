...
public class problem06 {
    ...
    /**
     * Fills the window with black colored square.
     * Precondition:  The mosaic window is open
     * postcondition: Each square has been set to black color.
     */
    ...
    /**
     * Changes one square to lighter shade of green
     * Precondition:  The specified rowNum and ColNum are in the valid range
     *                of row and column numbers.
     * Postcondition: The square in the specified row and column has been
     *                set shade of green.
     * @param rowNum - row number of the square from the top
     * @param colNum - column number of the square from the left
     */
    static void addGreen(int rowNum, int colNum) {
    	if(Mosaic.getGreen(rowNum, colNum) < 255) {
    		int g = Mosaic.getGreen(rowNum, colNum) + 25;
